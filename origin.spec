...
%{!?commit:
%global commit fd89727ad9da51a4349509de7466c654644bc1b6
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_COMMIT=e795244084 OS_GIT_VERSION=v4.1.0+e795244-1411 OS_GIT_MAJOR=4 OS_GIT_MINOR=1+ OS_GIT_PATCH=0 ETCD_GIT_VERSION=v3.3.10 ETCD_GIT_COMMIT=27fc7e2 KUBE_GIT_VERSION=v1.14.0+e795244084 KUBE_GIT_COMMIT=e8fcd6a KUBE_GIT_MAJOR=1 KUBE_GIT_MINOR=14+ OS_GIT_TREE_STATE=clean
}
...
%changelog
* Wed Sep 04 2019 Christian Glombek <cglombek@redhat.com> 0.0.1-1
